    ...
    <div className="pt-[92px] lg:pt-[104px] overflow-x-hidden">
          ...
          <div className="space-y-10 mb-10">
            ...
            <div>
              <div className="flex flex-wrap items-center justify-between mb-4">
                ...
                >
                  <Ruler className="h-3.5 w-3.5 group-hover:text-gold transition-colors" strokeWidth={1.3} />
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-4 sm:gap-3">
              ...
              <Button
                ...
                className="min-h-[3.5rem] h-auto py-4 min-w-0 flex-1 px-6 text-[0.8rem] font-bold uppercase tracking-[0.2em] rounded-none bg-foreground text-background shadow-md transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-1 hover:bg-foreground/80 hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] active:scale-[0.98] active:translate-y-0 gap-3 w-full"
              >
            ...
            <Link to="/checkout" className="flex min-h-[3.5rem] h-auto py-4 w-full items-center justify-center border border-foreground bg-transparent text-[0.8rem] font-bold uppercase tracking-[0.2em] text-foreground transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-1 hover:bg-foreground hover:text-background hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.3)] active:scale-[0.98] active:translate-y-0">
              Buy it now
            </Link>
          </div>
          ...
          <div className="mt-14 space-y-px bg-border/40">
            <details className="group bg-background" open>
              <summary className="flex cursor-pointer list-none items-center justify-between py-5 text-[0.75rem] font-medium tracking-[0.15em] uppercase transition-colors hover:text-gold">
                Fabric & Care
                <Plus className="h-4 w-4 transition-transform group-open:rotate-45" strokeWidth={1.3} />
              </summary>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[60] flex items-center justify-between gap-4 border-t border-border bg-background/95 px-5 py-4 pb-[max(1rem,env(safe-area-inset-bottom))] backdrop-blur-xl lg:hidden shadow-[0_-4px_24px_rgba(0,0,0,0.02)]">
        ...
        <Button
          disabled={sizeUnavailable}
          onClick={() => add(product.id, size, qty)}
          className="min-h-[3rem] h-auto py-3 w-full max-w-[170px] px-2 text-[0.7rem] font-bold uppercase tracking-[0.15em] rounded-none bg-foreground text-background shadow-md transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] hover:-translate-y-1 hover:bg-foreground/80 hover:shadow-[0_8px_30px_-8px_rgba(0,0,0,0.3)] active:scale-[0.98] active:translate-y-0"
        >
          {sizeUnavailable ? "Sold out" : "Add to Cart"}
        </Button>
      </div>
