    ...
    <div className="pt-[92px] lg:pt-[104px] overflow-x-hidden">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-stretch gap-4 sm:gap-3">
              ...
              <Button
                ...
                className="min-h-[3.5rem] h-auto py-4 min-w-0 flex-1 px-6 text-[0.8rem] font-bold uppercase tracking-[0.2em] rounded-none shadow-[0_4px_14px_0_rgb(0,0,0,0.05)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.15)] active:scale-[0.98] active:translate-y-0 gap-3 w-full"
              >
      ...
      <div className="fixed inset-x-0 bottom-0 z-[60] flex items-center justify-between gap-4 border-t border-border bg-background/95 px-5 py-4 pb-[max(1rem,env(safe-area-inset-bottom))] backdrop-blur-xl lg:hidden shadow-[0_-4px_24px_rgba(0,0,0,0.02)]">
        ...
        <Button
          disabled={sizeUnavailable}
          onClick={() => add(product.id, size, qty)}
          className="min-h-[3rem] h-auto py-3 w-full max-w-[170px] px-2 text-[0.7rem] font-bold uppercase tracking-[0.15em] rounded-none shadow-[0_4px_14px_0_rgb(0,0,0,0.05)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(0,0,0,0.15)] active:scale-[0.98] active:translate-y-0"
        >
          {sizeUnavailable ? "Sold out" : "Add to Cart"}
        </Button>
      </div>
